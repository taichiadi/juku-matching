...
export const metadata: Metadata = {
  title: "小論文添削オンライン｜現役早慶の予備校講師が1枚¥500で添削",
  description:
    "小論文の添削をオンラインで。現役早慶の予備校講師が、構成・内容・表現を1枚¥500で添削し、志望校の傾向に合わせた改善点と書き直し方針まで提示します。",
  keywords: [
    "小論文添削",
    "小論文 添削 オンライン",
    "小論文 添削 安い",
  ...
  openGraph: {
    ...
    description:
      "現役早慶の予備校講師が、小論文を1枚¥500で添削。志望校の傾向に合わせて改善点と書き直し方針を提示します。",
...
const FAQ: [string, string][] = [
  ["料金はいくらですか？", "1枚¥500です。英作文も¥500、過去問分析は1教科¥500です。"],
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              {[
                ...
                { icon: "💰", t: "1枚¥500の手頃さ", d: "塾の添削講座より気軽。必要なときに1枚から出せる都度払い。" },
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <Link href="/eisakubun-tensaku" className="rounded-2xl border border-slate-200 bg-white p-6 transition-all hover:-translate-y-0.5 hover:border-cyan-200">
                ...
                <p className="mt-2 text-sm leading-7 text-slate-600">英作文・自由英作文を1枚¥500で添削。</p>
              </Link>
              <Link href="/kakomon-tensaku" className="rounded-2xl border border-slate-200 bg-white p-6 transition-all hover:-translate-y-0.5 hover:border-cyan-200">
                ...
                <p className="mt-2 text-sm leading-7 text-slate-600">配点・頻出論点・捨て問判断＋答案添削。¥500（英語・国語）。</p>
              </Link>
