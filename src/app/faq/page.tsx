...
const FAQ_CATEGORIES = [
  {
    ...
    questions: [
      {
        q: "無料でできることは何ですか？",
        a: "先輩の体験記・合格ルートの閲覧、先輩マッチング、現在地チェック、学習計画がすべて無料でご利用いただけます。チャット相談はログイン済みの方は初回無料・2回目以降¥500。添削（¥500/枚〜）・過去問分析（¥500/1教科）は都度払いです。",
      },
      {
        q: "支払い方法は何に対応していますか？",
  ...
  },
  {
    ...
    questions: [
      {
        q: "どんな質問でも答えてもらえますか？",
        a: "英語・現代文・古文・漢文・数学・日本史・世界史・政治経済・小論文・英作文に対応しています。英語長文の写真やPDFも添付して送ることができます。ただし、回答は24時間以内が目安で、即時返答は保証されません（プロプランは5〜15分の優先返信保証あり）。",
      },
      {
        q: "添削はどのように行われますか？",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "小論文の添削をしてほしいです。",
        a: "ダッシュボードの「添削を依頼する」から提出できます。志望校名・字数制限も一緒に入力していただくと、より具体的なフィードバックができます。",
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: "塾に行かなくても合格できますか？",
        a: "できます。体験記の中にも独学合格者は多くいます。ただし自分でスケジュール管理・教材選び・弱点分析ができる必要があります。参考書の選び方や勉強の進め方に迷う場合は、塾よりまずこちらの質問窓口を活用してください。チャット相談はログイン済みの方は初回無料です。",
      },
      {
        q: "スタディサプリだけで合格できますか？",
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="mt-12 rounded-3xl bg-slate-950 px-8 py-10 text-center text-white">
          ...
          <p className="mt-2 text-sm text-slate-300">
            ...
            チャット相談はログイン済みなら初回無料。まず先輩に話を聞いてみてください。
          </p>
